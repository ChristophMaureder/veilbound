...
export function newCharacter(name: string, ruleset: Ruleset, statTiers?: Record<CoreStat, Tier>): Character {
  ...
  return {
    ...
    inventory: [],
    bags: defaultBags(),
    actionTabs: [{ id: uid('tab'), name: 'All', tags: [], names: [], matchMode: 'any', showDescriptions: true, layout: 'list', columnSize: 1, columns: [], costOrder: [], unsortedLabel: 'Unsorted', hideUnsorted: false, children: [] }],
